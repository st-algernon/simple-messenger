...
namespace zad5.Helpers
{
    public class TokenHelper
    {
        ...
        public async Task<AuthResponse> GenerateJwtAsync(User user)
        {
            ...
            var refreshToken = await CreateRefreshToken(jwt, user);
        ...
        private async Task<RefreshToken> CreateRefreshToken(JwtSecurityToken jwt, User user)
        {
